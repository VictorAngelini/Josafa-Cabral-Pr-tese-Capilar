      ...
      <header className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <span className="text-2xl font-serif font-bold text-primary tracking-tight">Josafá</span>
            <span className="hidden sm:inline-block text-sm font-medium text-secondary uppercase tracking-widest pt-1">Hair & Prótese</span>
          </Link>
